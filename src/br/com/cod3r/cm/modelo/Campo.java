...
public class Campo {
	...
	private void notificarObservadores(CampoEvento evento) {
		observadores.stream()
			.forEach(observador -> observador.eventoOcorreu(this, evento)); // esse this diz respeito ao objeto atual (que no caso é o a classe Campo)
	}
	...
	boolean adicionarVizinho(Campo vizinho) {
		...
		if (deltaGeral == 1 && !diagonal) { // vizinho na coluna ou linha
